      ...
      <div class="error-content">
        ...
        <details class="technical-details">
          ...
          <div class="technical-content">
            ...
            <p><strong>Error:</strong> {{ errorMessage || 'Connection timeout or server unreachable' }}</p>
...
const baseUrl = import.meta.env.PUBLIC_API_BASE_URL || 'http://localhost:3000/api';
</script>
